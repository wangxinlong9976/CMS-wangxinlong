...
import com.wxl.cms.common.UploadResult;

@RequestMapping("/file/")
@Controller
public class  FileController{
	
	String picRoot = "D:/pic/";
	String picUrl = "/pic/";
	...
	@ResponseBody
	public UploadResult upFile(HttpServletRequest request, @RequestParam("imgFile") MultipartFile imgFile) throws FileUploadException {
		return upload(request,imgFile);
	}
	@SuppressWarnings("unused")
	@RequestMapping("upload")
	@ResponseBody
	public UploadResult upload(HttpServletRequest request, @RequestParam("imgFile") MultipartFile imgFile) throws FileUploadException {
		...
		List<UploadResult> fileList = new ArrayList<>();
		...
		return new UploadResult(saveUrl + newFileName,0);
	...
	@ResponseBody
	@RequestMapping("/upload")
	public UploadResult upload(@RequestParam("imgFile")MultipartFile file) throws IOException{
		String picUrl = "/pic/";
		
		String url = picRoot+file.getOriginalFilename();
		...
		is.close();
		os.close();
		UploadResult uploadResult = new UploadResult(picUrl,1);
