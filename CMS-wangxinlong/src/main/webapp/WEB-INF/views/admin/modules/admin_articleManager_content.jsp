...
<hr/>
	<div class="row">
		...
		<div class="col-2">
			<input type="text" class="form-control" style="margin-left:-20px" placeholder="请输入关键字.."/>
		</div>
		<div class="col-1">
		...
		<div class="col-2">
			<select class="form-control text-center" style="margin-left: -85px;" id="channel">
				<option>全部</option>
			</select>
		</div>
		<div class="col-1">
		...
		<div class="col-2">
			<select class="form-control" style="margin-left: -160px;" id="category">
		...
		<div class="col-2">
			<div class="row">
				<select class="form-control" style="margin-left: -200px;">
					<option value="">全部</option>
					<option value="1">已审核</option>
					<option value="-1">未审核</option>
				</select>
				<button type="button" class="btn btn-primary" style="margin-left:30px;width:130px">查询</button>
			</div>
		</div>
	</div>
	<hr/>
		...
		<tr>
			...
			<c:forEach items="${list}" var="article" varStatus="status">
				<tr>
					...
					<td></td>
					<td></td>
					<td><input type="button" value="查看" class="btn btn-success"/><input type="button" value="${user.locked==1?'禁用':'启用'}" class="btn btn-danger"/></td>
				</tr>
			</c:forEach>
